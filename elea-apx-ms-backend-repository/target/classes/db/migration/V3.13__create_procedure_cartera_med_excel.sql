CREATE PROCEDURE [dbo].[Reporte_Cartera_Medica] @ciclo int
AS
BEGIN
	...
	JOIN especialidad e2 ON e2.id=d.espeSubespecialidad_id
	...
	WHERE cm.inactivo = 0
	AND cm.created_date BETWEEN ci.inicio AND ci.fin 
