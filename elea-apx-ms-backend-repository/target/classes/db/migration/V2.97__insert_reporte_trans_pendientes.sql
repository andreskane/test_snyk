CREATE PROCEDURE [dbo].[Reporte_Transferencias_Pendientes]
AS
BEGIN
...
where ((t.fecha is null and fechaProgramada is null) or (t.fecha is null and programada_confirmada = 0));
